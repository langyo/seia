...
seia поддерживает 8 бэкендов, все они доступны через официальный HTTP-API (или,
...
| --- | --- | --- |
| **API** | Вызывает HTTP-API поискового провайдера, разбирает JSON. | Tavily, SearXNG, Wikipedia, Bing, Brave, 智谱, 博查 |
