...
seia prend en charge 8 backends, tous atteints via leur API HTTP officielle (ou,
...
| --- | --- | --- |
| **API** | Appelle l'API HTTP d'un fournisseur de recherche, analyse le JSON. | Tavily, SearXNG, Wikipedia, Bing, Brave, 智谱, 博查 |
